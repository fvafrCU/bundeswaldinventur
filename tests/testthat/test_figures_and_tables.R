#' Tests the outputs of the functions of the file figures_and_tables.R.
#' 
#' @author Franziska Berg
#' @section Version: 04.11.2015
#' @section Note: graphic functions are not tested.
#' @name A Header for
NULL

context("figures_and_tables")

test_that("melt_species_attribute_group", {
...
#Not tested, encoding problems
test_that("all_data_by_group", {
