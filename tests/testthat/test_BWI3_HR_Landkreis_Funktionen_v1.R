...
test_that("flaechen.kreis.fun.1", {
  ...
  reference <- structure(list(
    ...
    .Names = c(
      "BWI", "Waldfl_GW", "SE_Waldfl_GW", "Waldfl_StW",
  ...
  .Names = c(
    "Kreis", "KreisCode", "Kreisfläche_gesamt_ha", "Waldanteil",
...
test_that("flaechen.stratum.fun.1", {
  ...
  reference <- structure(list(
    ...
    Waldfl_Proz = structure(list(Eigentum = structure(c(
      7L,
      3L, 5L, 6L, 1L, 4L, 2L
    ), .Label = c(
      "GPW", "KPW", "KW", "MPW",
      "OEW", "PW", "StW(BW)"
    ), class = "factor"), Waldfl_Proz = c(
      24,
      40, 64, 36, 11.1, 13.6, 11.3
    ), SE_Waldfl_Proz = c(
      0.7, 0.7, 0.7,
      0.7, 0.5, 0.5, 0.4
    )), .Names = c("Eigentum", "Waldfl_Proz", "SE_Waldfl_Proz"), row.names = c(NA, -7L), class = "data.frame"),
    begehb_Holzbfl = structure(list(
      Eigentum = structure(c(2L, 8L, 4L, 6L, 7L, 1L, 5L, 3L), .Label = c(
        "GPW",
        "GW", "KPW", "KW", "MPW", "OEW", "PW", "StW(BW)"
      ), class = "factor"),
      b_HBF = c(
        1323958, 310978, 527802, 844684, 479275, 148185,
        180904, 150186
      ), SE_begehb_Holzbfl = c(
        15761, 9650, 11504,
        13981, 10515, 6695, 6543, 5062
      )
    ), .Names = c(
      "Eigentum", "b_HBF",
      "SE_begehb_Holzbfl"
