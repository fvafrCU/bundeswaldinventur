  ...
  l <- switch(type,
    "regional" = list(
      ...
      ba.grupp = list(
        ...
        c(
          113, 114, 121, 141:144, 150, 160, 170, 180,
          181, 190:199
        ),
        c(
          200, 201, 210:213, 220:224, 230, 240, 250:252,
          290:299
        )
      ),
      ba.text = c(
        "Fichte", "Wei\u00dftanne", "Douglasie", "Kiefer",
...
get_species_groups <- function() {
  l <- list(
    ...
    colors = c(
      get_bwi_species_groups()$ba.colors[1:2],
...
get_bwi_colors <- function() {
  colors <- c(
    grDevices::rgb(154, 205, 050, maxColorValue = 255),
